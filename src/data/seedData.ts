...
export const MASTER_APPS_SCRIPT_URL = "";

export const INITIAL_SEED_SATELLITES: SatelliteNode[] = [
  {
    id: 1789107210113,
  ...
  },
  {
    ...
    pressure: 946.8,
    windSpeed: 12,
    principalName: "Versatile School Authority",
    lat: 18.5089,
    lng: 73.8258,
...
// Clean dataset returning our registered student CanSat modules
export function generateFullSeedDataset(): SatelliteNode[] {
